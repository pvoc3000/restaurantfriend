...
4. 🚧 Web order guide + PO generation/processing + receiving (real Monday orders).
   ...
   **PO DETAIL'S COMMANDS ARE ONE ACTIONS MENU** (Mark, 2026-09-11) — level
   ...
   plugins do not reload) — with the card at the FOOT of its column
   (`xl:self-stretch` on the column, `mt-auto` on the card) and six
   right-aligned figures ABOVE it (they sat under it until later the same day):
...
- **The look is the `restaurantfriend-design` skill** (a user skill, outside
  ...
  **there are no switches** (Mark, 2026-09-11 — every on/off control is
