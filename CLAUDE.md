...
4g. 🚧 Special orders (quotes, documents, /q approval, /inquiry, standing orders, scheduling, /pay link via Square, customer invoices — 124 + 125 applied, 126 written) — `docs/history/04g-special-orders.md`
