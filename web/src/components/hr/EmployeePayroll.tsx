...
/**
 * The four payroll settings that live on the person.
 *
 * ALL FOUR HAD NO UI WRITER ANYWHERE until this block. `gusto_id` and
...
export function EmployeePayroll({
  ...
  return (
    <dl className="grid max-w-2xl grid-cols-[10rem_1fr] gap-x-4 gap-y-1 text-sm">
      ...
      <dt className="py-0.5 text-subtle">Homebase id</dt>
      <dd>
        {editable ? (
          <InlineValue
            table="employees"
