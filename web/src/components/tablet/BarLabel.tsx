...
/** A door with an arrow leaving it — Sign out, drawn at the bar's weight. */
export const ICON_LOGOUT =
  "M186-80q-54 0-80-26t-26-80v-588q0-54 26-80t80-26h294v126H206v548h274v126H186Zm458-150-89-89 98-98H360v-126h293l-98-98 89-89 250 250-250 250Z";
/**
 * Material Symbols `settings`, FILLED — the gear for Settings (your own
 * account: name, password, PIN). Filled rather than outlined because the
 * outline's thin ring reads faint beside the bar's heavy glyphs.
 */
